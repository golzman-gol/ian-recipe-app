...
import { ArrowLeft, Save, Trash2, Image as ImageIcon, Plus, Loader2, ChevronDown, ChevronUp, Link as LinkIcon, X } from 'lucide-react';
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <button onClick={() => addSectionReference(section.id)} className="p-1 hover:bg-zinc-200 rounded-full bg-zinc-100 text-zinc-600 transition-colors"><Plus className="w-4 h-4" /></button>
                        </div>

...
export function TechniqueView({ technique, onBack, onEdit, onDelete }: TechniqueViewProps) {
              ...
              return (
                <div key={idx} className="bg-white border rounded-2xl overflow-hidden shadow-sm flex flex-col">
                  {yt ? (
                    ...
                    <div className="aspect-video bg-zinc-100 flex items-center justify-center"><Link /></div>
                  )}
